...
public class TBScreeningComposite extends Composite implements ClickHandler, ChangeHandler, ValueChangeHandler<Boolean>
{
	...
	public void clearUp ()
	{
		...
		ListBox[] listBoxes = {coughComboBox, coughDurationComboBox, productiveCoughComboBox, haemoptysisComboBox, chestPainComboBox, chestPainDurationUnitComboBox, breathingShortnessComboBox,
				breathingShortnessDurationUnitComboBox, nightSweatsComboBox, nightSweatsDurationUnitComboBox, weightLossComboBox, weightLossDurationUnitComboBox, feverComboBox,
				feverDurationUnitComboBox, lymphNodeComboBox, lymphNodeDurationUnitComboBox, tbHistoryComboBox, treatmentHistoryComboBox, treatmentHistoryDurationUnitComboBox,
				treatmentDurationUnitComboBox, treatmentCompletedComboBox, familyTBHistoryComboBox};
		CheckBox[] checkBoxes = {durationFormTreatmentToDateCheckBox, durationOfTreatmentCheckBox, conclusionCheckBox};
