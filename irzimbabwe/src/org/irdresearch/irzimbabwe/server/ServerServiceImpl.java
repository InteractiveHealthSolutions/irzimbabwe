...
public class ServerServiceImpl extends RemoteServiceServlet implements ServerService
{
	...
	private Boolean saveEncounterResults (EncounterResults encounterResults)
	{
		 ...
		 * PROBLEM: We cannot fix the regex in db for the ATTRIBUTE or the VALUE because it will vary for different fields
		 * SO,in order to validate the CLIENT EDIT I access the Encounter_elements() in the savePatientEdit
		 * */
